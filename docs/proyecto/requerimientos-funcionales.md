...
El sistema debe permitir que un visitante cree una cuenta ingresando nombres, apellidos, correo electrónico, contraseña, confirmación de contraseña y aceptación de los términos.
...
- Cuando el autoguardado está activo, el editor permite recuperar o descartar la última copia local del mismo usuario durante un máximo de 7 días.
- El respaldo local se elimina al desactivar el autoguardado, cerrar sesión, vencer o detectar que pertenece a otra cuenta.
