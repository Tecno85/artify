...
- Treinta y siete pruebas automatizadas: 25 del backend para autenticación, sesiones, configuración, imágenes, analíticas, administración y seguridad HTTP, y 12 del frontend para sesión, login por rol, inicio del editor y renderizado seguro.
