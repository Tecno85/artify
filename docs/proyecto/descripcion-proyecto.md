...
- Treinta y seis pruebas automatizadas: 24 del backend para autenticación, sesiones, configuración, imágenes, analíticas, administración y seguridad HTTP, y 12 del frontend para sesión, login por rol, inicio del editor y renderizado seguro.
