...
En este documento registro el proceso seguido para consolidar Artify como versión oficial con backend Node.js + Express y base de datos PostgreSQL. Este repositorio es la referencia oficial; la versión histórica del proyecto base se conserva fuera de él para mantener la trazabilidad.
...
| --- | --- | --- |
| 1 | Preparo el repositorio PostgreSQL | Repositorio oficial organizado con trazabilidad histórica. |
...
| 7 | Preparo despliegue | GitHub Pages, Render y Neon PostgreSQL. |
...
10. Despliego y verifico el frontend, el backend y la base de datos en sus servicios correspondientes.
