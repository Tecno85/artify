...
| Ejecutar `pnpm run test:e2e` | Antes de entregar cambios del editor o de sus modales | Flujo real de filtro, historial, descarga y teclado aprobado en Chromium. |
...
| Editor o modales | `cd backend && pnpm run test:e2e` |
